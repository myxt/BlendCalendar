...
{def $calendars=ezini('BlendCalendarSettings','CalendarClasses','content.ini')}

{if $calendars|contains($node.object.class_identifier)}
	...
	<div class="content-view-calendar">
		<div class="context-block">
			<div class="box-header">
				<h2 class="context-title">By Date</h2>
				<div class="header-subline"></div>
			</div>
			<div class="box-content">
				<div class="bc-quickview" 
					data-url={"/blendcalendar/30boxes"|ezurl}
					attribute-id="{ezini('BlendCalendarSettings','QuickViewClassAttributeId','content.ini')}"
					node-id="{$node.node_id}"
					month="{currentdate()|datetime('custom','%n')}"
					...
					<div class="load">
						<p style="text-align: center;padding-top:80px;"><img src={"calendar-load.gif"|ezimage} alt="Loading" /></p>
					</div>
